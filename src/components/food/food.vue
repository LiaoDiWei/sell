  ...
  <transition name="move">
    <div class="food" v-show="showFlag" ref="food">
        <div class="food-content">
            <div class="image-header" v-on:click="hide">
            ...
            <div class="content">
                ...
                <div v-on:click.stop.prevent="addFirst($event)" class="buy" v-show="!food.count || food.count === 0">
                    加入购物车
                </div>
            </div>
            ...
            <div class="rating">
              ...
              :only-content="onlyContent" :ratings="food.ratings"></ratingselect>
...
<script type="text/ecmascript-6">
 ...
 export default {
    ...
    created() {
       this.$root.bus.$on('ratingtype.select', (type) => {
           this.selectType = type;
           this.$nextTick(() => {
              this.scroll.refresh();
           });
       });
       this.$root.bus.$on('content.toggle', (onlyContent) => {
    ...
    methods: {
        ...
        addFirst(event) {
          ...
          //之前没有加入购物车
          this.$root.bus.$emit('cart-add', event.target);  //动画
          Vue.set(this.food, 'count', 1);
        },
        needShow(type, text) {
            //选择只看有内容但是没有具体内容的评价直接不显示
